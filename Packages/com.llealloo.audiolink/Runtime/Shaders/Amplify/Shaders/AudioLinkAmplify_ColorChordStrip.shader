...
Shader "AudioLink/Amplify/AudioLinkAmplify_ColorChordStrip"
{
	Properties
	{
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float Position1_g2 = texCoord1.x;
				float4 localAudioLinkLerp1_g2 = AudioLinkLerp1_g2( Position1_g2 );
				
				
				finalColor = localAudioLinkLerp1_g2;
				return finalColor;
			}
			ENDCG
		}
